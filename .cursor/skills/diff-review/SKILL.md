...
**Optional illustrations** — consider generating a hero banner or conceptual illustration using a Gemini 3+ subagent when it would enhance the page. Embed as base64 data URI. See css-patterns.md "Generated Images" for container styles. Skip if image generation isn't available or the diff is purely structural.
