...
**Visual richness:** Proactively reach for visuals. Use a Gemini 3+ subagent to generate images for title slide backgrounds and full-bleed slides. Add SVG decorative accents, inline sparklines, mini-charts, and small Mermaid diagrams where they make the story more compelling. Visual-first, text-second.
