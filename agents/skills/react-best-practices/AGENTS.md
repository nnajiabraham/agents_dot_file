...
Reference: [https://nextjs.org/docs/app/api-reference/config/next-config-js/optimizePackageImports](https://nextjs.org/docs/app/api-reference/config/next-config-js/optimizePackageImports)
...
const Analytics = dynamic(
  () => import('@acme/analytics/react').then(m => m.Analytics),
  { ssr: false }
)
...
Reference: [https://www.npmjs.com/package/swr](https://www.npmjs.com/package/swr)
...
3. [https://www.npmjs.com/package/swr](https://www.npmjs.com/package/swr)
4. [https://github.com/shuding/better-all](https://github.com/shuding/better-all)
5. [https://github.com/isaacs/node-lru-cache](https://github.com/isaacs/node-lru-cache)
6. [https://nextjs.org/docs/app/api-reference/config/next-config-js/optimizePackageImports](https://nextjs.org/docs/app/api-reference/config/next-config-js/optimizePackageImports)
7. [https://react.dev/learn/you-might-not-need-an-effect](https://react.dev/learn/you-might-not-need-an-effect)
