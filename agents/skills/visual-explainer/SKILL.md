...
license: MIT
compatibility: Requires a browser to view generated HTML files. Optional Gemini 3+ subagent for AI image generation.
metadata:
  author: nicobailon
  version: "0.4.4"
---
...
**AI-generated illustrations (optional).** Use a Gemini 3+ subagent in Cursor to generate images and embed them in the page for creative, illustrative, explanatory, educational, or decorative purposes.

Generate the image with the subagent, save the output image locally, then base64-embed it in the HTML for a self-contained file:

```bash
# Base64 encode for self-containment (macOS)
IMG=$(base64 -i /path/to/generated-image.png)
# Linux: IMG=$(base64 -w 0 /path/to/generated-image.png)
